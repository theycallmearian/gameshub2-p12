import RetroFrame from '/src/components/Layout/RetroFrame'
import ConnectFourBoard from '/src/components/ConnectFour/ConnectFourBoard'
import useConnectFourGame from '/src/hooks/useConnectFourGame'
import styles from './ConnectFour.module.css'
import { useState, useEffect } from 'react'
import ScoreBoardConnectFour from '/src//components/Scores/ScoreBoardConnectFour'
...
export default function ConnectFour() {
  ...
  return (
    <RetroFrame>
      ...
      <button className={`${styles.resetBtn} btn`} onClick={handleReset}>
        Reset
      </button>
      {state.winner && (
